# A Systematic Review of Privacy-Preserving Approaches in Deep Learning Applications

## Table of Contents
- [Search string](#search-string)
- [Reviewd publications](#reviewed-publications)
- [Excluded publications](#excluded-publications)
- [Publications that address multiple use cases](#publications-that-address-multiple-use-cases)
...
|Category|Title|First Author|Year|
|--------|-----|------|----|
|I1|An Efficient CKKS-FHEW/TFHE Hybrid Encrypted Inference Framework|Liu T.L.|2024|
|I1|Approximate Homomorphic Pre-Processing for CNNs|Khanna S.|2023|
|I1|AutoFHE: Automated Adaption of CNNs for Efficient Evaluation over FHE|Ao W.|2024|
|I1|C2PI: An Efficient Crypto-Clear Two-Party Neural Network Private Inference|Zhang Y.|2023|
|I1|CHAM: A Customized Homomorphic Encryption Accelerator for Fast Matrix-Vector Product|Ren X.|2023|
|I1|CHE: Channel-Wise Homomorphic Encryption for Ciphertext Inference in Convolutional Neural Network|Xie T.|2022|
|I1|Cheetah: Lean and Fast Secure Two-Party Deep Neural Network Inference|Huang Z.|2022|
|I1|Cheetah: Optimizing and Accelerating Homomorphic Encryption for Private Inference|Reagen B.|2021|
...
|I1|CryptoSPN: Privacy-preserving sum-product network inference|Treiber A.|2020|
|I1|Deep Binarized Convolutional Neural Network Inferences over Encrypted Data|Zhou J.|2020|
|I1|DeepSecure: Scalable Provably-Secure Deep Learning|Rouhani B.|2018|
...
|I1|Oblivious Neural Network Predictions via MiniONN Transformations|Liu J.|2017|
...
|I1|Statistical Privacy for Streaming Traffic|Zhang X.|2019|
...
|T1|Deep Learning Algorithms Design and Implementation Based on Differential Privacy|Xu X.|2020|
...
|T1|ProGAP: Progressive Graph Neural Networks with Differential Privacy Guarantees|Sajadmanesh S.|2024|
...
|T3|Binary Federated Learning with Client-Level Differential Privacy|Liu L.|2023|
...
|T3|NN-EMD: Efficiently Training Neural Networks Using Encrypted Multi-Sourced Datasets|Xu R.|2022|
...
|T3|Trident: Efficient 4PC Framework for Privacy Preserving Machine Learning|Chaudhari H.|2020|
|T3|TripleBlind: A Privacy-Preserving Framework for Decentralized Data and Algorithms|Gharibi G.|2022|
|T3|Verifiable Privacy-Preserving Federated Learning Under Multiple Encrypted Keys|Shen X.|2023|
|T4|Local Differential Privacy for Deep Learning|Mahawaga Arachchige P.C.|2020|
|T4|NPNNL: A Non-interactive Privacy-preserving Neural Network Learning Scheme|Lei D.|2023|
|T4|On lightweight privacy-preserving collaborative learning for internet-of-things objects|Jiang L.|2019|
|T4|Privacy-preserving deep learning for electricity consumer characteristics identification|Zhang Z.|2022|
...
|6th International Symposium on Cyber Security Cryptography and Machine Learning, CSCML 2022||2022|
|7th Latin American High Performance Computing Conference, CARLA 2020||2021|
|A Differentially Private Federated Learning Model for Fingerprinting Indoor Localization in Edge Computing|Zhang X.|2022|
|A multi-layer parallel hardware architecture for homomorphic computation in machine learning|Xin G.|2021|
|A Quantifying Approach for Evaluating Differential Privacy in Deep Learning|Yin L.|2022|
|A Systematic Comparison of Encrypted Machine Learning Solutions for Image Classification|Haralampieva V.|2020|
|Accelerator Design and Performance Modeling for Homomorphic Encrypted CNN Inference|Ye T.|2020|
|Accuracy-Privacy Trade-off in Deep Ensemble: A Membership Inference Perspective|Rezaei S.|2023|
|Adversary instantiation: Lower bounds for differentially private machine learning|Nasr M.|2021|
|AELGA-FHE: An Augmented Ensemble Learning Based Genetic Algorithm Model for Efficient High Density Fully Homomorphic Encryption|Dumbere D.M.|2022|
|An Efficient Convolution Core Architecture for Privacy-Preserving Deep Learning|Wang Y.|2018|
|Analysing speech for clinical applications|Trancoso I.|2018|
|Anonymising Video Data Collection at the Edge Using DeepDish|Pan W.|2023|
|BMIF: Privacy-preserving Blockchain-based Medical Image Fusion|Xiang T.|2023|
|Broad Learning Inference Based onÂ Fully Homomorphic Encryption|Deng X.|2023|
|Calibrating Privacy Budgets for Locally Private Graph Neural Networks|Du W.|2021|
|Challenges in Federated Learning for Resource-Constrained IoT Environments: Energy Efficiency, Privacy, and Statistical Heterogeneity|Umair M.|2023|
|ComBo: A Novel Functional Bootstrapping Method for Efficient Evaluation of Nonlinear Functions in the Encrypted Domain|Clet P.E.|2023|
|Continual Learning withÂ Differential Privacy|Desai P.|2021|
|CraterLake: A Hardware Accelerator for Efficient Unbounded Computation on Encrypted Data|Samardzic N.|2022|
|Crowdotic: A Privacy-Preserving Hospital Waiting Room Crowd Density Estimation with Non-speech Audio|Al Hossain F.|2024|
...
|Multi-key fully homomorphic encryption from NTRU and (R)LWE with faster bootstrapping|Xu K.|2023|
...
|Towards the AlexNet Moment for Homomorphic Encryption: HCNN, the First Homomorphic CNN on Encrypted Data with GPUs|Al Badawi A.|2021|
